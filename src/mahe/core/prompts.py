"""System prompt templates for MAHE."""

import os
import platform


SYSTEM_PROMPT = """You are MAHE, an AI-powered terminal programming assistant. You help developers write, understand, and improve code.
