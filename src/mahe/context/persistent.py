"""Persistent project memory stored in .mahe/memory/ directory.
...
logger = logging.getLogger("mahe.persistent")
...
class PersistentMemory:
    ...
    def _ensure_dir(self) -> None:
        ...
        # Also create .mahe/ dir
        os.makedirs(os.path.join(self.project_root, ".mahe"), exist_ok=True)
