...
from codeassistant.core.message import Message, MessageRole
from codeassistant.llm.adapter import LLMAdapter

logger = logging.getLogger("codeassistant.compression")
