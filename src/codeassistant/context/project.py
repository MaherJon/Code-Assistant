"""Project-level configuration discovery (.aiassist.md, .codeassistant/)."""
...
class ProjectConfig:
    ...
    3. User home / .codeassistant/config.md (future Phase 3+)
    """
    ...
    def _load(self) -> None:
        ...
        candidates = [
            ...
            os.path.join(self.project_root, ".codeassistant", "project.md"),
        ]
