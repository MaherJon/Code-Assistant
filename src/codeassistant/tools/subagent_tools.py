...
if TYPE_CHECKING:
    from codeassistant.core.subagent import SubAgentManager, SubAgentTask

logger = logging.getLogger("codeassistant.tools.subagent")
...
class DelegateTask(Tool):
    ...
    async def execute(self, tasks: List[dict], parallel: bool = True) -> ToolResult:
        ...
        from codeassistant.core.subagent import SubAgentTask
