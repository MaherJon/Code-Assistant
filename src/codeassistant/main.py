"""CLI entry point for CodeAssistant."""
...
from codeassistant.cli.commands import chat, ask, config, index_cmd, mcp, loop
...
@click.option("--api-key", help="API key (or set CODEASSISTANT_API_KEY / OPENAI_API_KEY env var)")
...
@click.version_option(version="0.1.0", prog_name="codeassistant")
@click.pass_context
